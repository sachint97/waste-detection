...
class DataValidation:
    def __init__(
        ...
        try:
            self.data_ingestion_artifactt = data_ingestion_artifact
    ...
    def validate_all_files_exist(self) -> bool:
        try:
            ...
            all_files = os.listdir(self.data_ingestion_artifactt.feature_store_path)
    ...
    def initiate_data_validation(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("Exited data vaidation")
            logging.info(f"Data validation artifact: {data_validation_artifact}")

            if status:
                shutil.copy(self.data_ingestion_artifactt.data_zip_file_path, os.getcwd())
